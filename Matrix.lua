...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,114518657,1111100}
...
var = true  
elseif tonumber(user_id) == tonumber(1111100) then
var = true  
...
local NameUser = "[- Matrix 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/X04XX)\n — — — — — — — — —\n❢ بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- Matrix 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/X04XX)\n — — — — — — — — —\n❢ اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
if result.id_ == tonumber(1111100) then
send(msg.chat_id_, msg.id_, "❢ لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
if userid == tonumber(1111100) then
send(msg.chat_id_, msg.id_, "❢ لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
send(msg.chat_id_, msg.id_,"[- Matrix 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/X04XX)\n — — — — — — — — —\n❢ العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "X04XX")..")".."\n❢ تم رفعه "..RTPA.." هنا\n")
...
if DevMatrix(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Matrix/files_Matrix/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Matrix/files_Matrix/master/files_Matrix/"..file)
if res == 200 then
...
os.execute('rm -rf Matrix.lua')
os.execute('rm -rf start.lua')
os.execute('wget https://raw.githubusercontent.com/Matrix/Matrix/master/Matrix.lua')
os.execute('wget https://raw.githubusercontent.com/Matrix/Matrix/master/start.lua')
dofile('Matrix.lua')  
return false
end
...
inline = {
{{text = '❢  Matrix 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/X04XX'}},
}
