...
os.execute('wget https://raw.githubusercontent.com/Matrix Tele/Matrix/master/Matrix.lua')
os.execute('wget https://raw.githubusercontent.com/Matrix Tele/Matrix/master/start.lua')
dofile('Matrix.lua')  
return false
end
if text == "راسلني" then
...
if DevMatrix(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Matrix Tele/files_MATRIX/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Matrix Tele/files_MATRIX/master/files_MATRIX/"..file)
if res == 200 then
