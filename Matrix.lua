...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,114518657,1111}
print("\27[34m"..[[
...
if hash or DevMatrix(msg) or DevBot(msg) or BasicConstructor(msg) then    
return true    
else    
return false    
end 
...
if hash or DevMatrix(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) then    
return true    
else    
return false    
end 
...
if hash or DevMatrix(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) then    
return true    
else    
return false    
end 
...
if hash or DevMatrix(msg) or DevBot(msg) or BasicConstructor(msg) or Constructor(msg) or Owner(msg) or Addictive(msg) then    
return true 
else 
return false 
end 
...
if text == (database:get(bot_id.."Matrix:Name:Bot") or "تمبلر") then
Namebot = (database:get(bot_id.."Matrix:Name:Bot") or "تمبلر")
local namebot = {
...
if DevMatrix(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Matrixabas/files_Matrix/master/getfile.json")
if res == 200 then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Matrixabas/files_Matrix/master/files_Matrix/"..file)
if res == 200 then
...
[«🥇|Matrix 𝖲𝗈𝗎𝗋𝖼𝖾.⚙️.](https://t.me/X04XX)
					
[«🔰 | 𝖣𝗈𝗐𝗇𝗅𝗈𝖺𝖽 𝖥𝗋𝗈𝗆 𝖸𝗈𝗎𝗍𝖾𝖻.⚙️. ](http://t.me/X23BOT)
					
[«🗳| Matrix 𝖲𝗈𝗎𝗋𝖼𝖾.⚙️.](http://t.me/X04XX)
					
[«⚜️| SimSimi 𝖡𝗈𝗍 𝖬𝖺𝗄𝖾𝗋.〽️.](http://t.me/Rr90bot)
					
[«⚠️ | 𝖡𝗈𝗍 𝖯𝗋𝗈𝗍𝖾𝖼𝗍𝗂𝗈𝗇 𝖢𝗁𝖺𝗇𝗇𝖾𝗅𝗌.💯.](http://t.me/Matrix_file)
					
[«🚸 | 𝖲𝗈𝗎𝗋𝖼𝖾 𝖢𝗈𝗇𝗍𝗂𝗇𝗎𝖾𝗌.✅.](https://t.me/U41bot)
...
local Name_Bot = (database:get(bot_id.."Matrix:Name:Bot") or "تمبلر")
