...
redis:set('Matrix:'..bot_id..'n1'..msg.sender_user_id_..'','yes')
return false end 
local keko2 = redis:get('Matrix:'..bot_id..'n1'..msg.sender_user_id_)
if keko2 == 'yes' then
if text:match("^(.*)$") then
send(msg.chat_id_, msg.id_, 1, '🙋🏻‍♂️※ تم حفظ الاسم ✓\n🕹※ الان ارسل ايدي حسابك', 1, 'html')
redis:set('Matrix:'..bot_id..'n1'..msg.sender_user_id_..'','no')
redis:set('Matrix:'..bot_id..'name_acount'..msg.sender_user_id_, text)
redis:set('Matrix:'..bot_id..'n2'..msg.sender_user_id_ ,'yes')
return false end
end 
local keko2 = redis:get('Matrix:'..bot_id..'n2'..msg.sender_user_id_)
if keko2 == 'yes' then
if text:match("^(%d+)$") then
redis:set('Matrix:'..bot_id..'idacount'..msg.sender_user_id_, text)
redis:set('Matrix:'..bot_id..'n2'..msg.sender_user_id_, 'no')
local aa = [[
🙋🏻‍♂️※ تم حفض الايدي ✓
🕹※ الان ارسل تقيمك
ارسل تقيمك كمثال ⚜️: 
...
redis:set('Matrix:'..bot_id..'n3'..msg.sender_user_id_, 'yes')
return false 
else 
send(msg.chat_id_, msg.id_, 1, '🕹※ هناك خطاء في الايدي حاول مره اخرئ', 1, 'html')
return false end
end
local keko2 = redis:get('Matrix:'..bot_id..'n3'..msg.sender_user_id_)
if keko2 == 'yes' then
...
redis:set('Matrix:'..bot_id..'n3'..msg.sender_user_id_, 'no')
send(msg.chat_id_, msg.id_, 1, '🙋🏻‍♂️※ تم حفض تقيمك ✓\n🕹※ تم حفض حسابك ✓', 1, 'html')
redis:set('Matrix:'..bot_id..'acctear'..msg.sender_user_id_, text)
return false 
else 
...
redis:del('Matrix:'..bot_id..'idacount'..msg.sender_user_id_)
redis:del('Matrix:'..bot_id..'acctear'..msg.sender_user_id_)
redis:del('Matrix:'..bot_id..'name_acount'..msg.sender_user_id_)
send(msg.chat_id_, msg.id_, 1,"🎟 ※ تم مسح حسابك", 1, 'md')
end
if (text and text == 'حسابي')then
if redis:get('Matrix:'..bot_id..'idacount'..msg.sender_user_id_)then
local n = redis:get('Matrix:'..bot_id..'idacount'..msg.sender_user_id_)
local nn = redis:get('Matrix:'..bot_id..'acctear'..msg.sender_user_id_)
local nnn = redis:get('Matrix:'..bot_id..'name_acount'..msg.sender_user_id_)
...
Text = [[
 ۞ ۩ ✟ 『  』۝ Ξ 道 凸 父 个 ¤ 品 〠 ๛ 𖤍 ᶠᶸᶜᵏᵧₒᵤ ࿐ ⍆ ⍅ ⇭ ༒   𖠃 𖠅 𖠆 𖠊 𖡒 𖡗 𖣩 ꧁ ꧂  〰 𖥓 𖥏 𖥎 𖥌 𖥋 𖥊 𖥈 𖥅 𖥃 𖥂 𖥀 𖤼 𖤹 𖤸 𖤷 𖤶 𖤭 𖤫 𖤪 𖤨 𖤧 𖤥 𖤤 ?? 𖤢 𖤡 𖤟 𖤞 𖤝 ?? 𖤛 𖤚 ?? 𖤙 𖤗 𖤕 𖤓 𖤒 𖤐 ဏ ࿘ ࿗ ࿖ ࿕ ࿑ ࿌ ࿋ ࿊ ࿉ ࿈ ࿇ ࿅ ࿄ ࿃ ࿂ ༼ ༽ ༺ ༻ ༗ ༖ ༕ ⏝ ⏜ ⏎ ၄ ߷ ܛ ׀
