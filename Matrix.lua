...
local UserName = (data.username_ or "MaTrIxX0")
local NameUser = "[- Matrix 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/MaTrIxX0)\n  - - - - - - - - -\n• بواسطه ↺ ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- Matrix 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/MaTrIxX0)\n  - - - - - - - - -\n• اسم المستخدم ↺ ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
send(msg.chat_id_, msg.id_,"[- Matrix 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/MaTrIxX0)\n  - - - - - - - - -\n• العضو ↺ ["..data.first_name_.."](t.me/"..(data.username_ or "MaTrIxX0")..")".."\n• تم رفعه "..RTPA.." هنا\n")
...
if Matrixrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"[- Matrix 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/MaTrIxX0)\n  - - - - - - - - -\n• العضو ↺ ["..result.title_.."](t.me/"..(text1[3] or "MaTrIxX0")..")".."\n• تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."Matrix:Special:User"..msg.chat_id_,result.id_)  
...
local UserName = (b.username_ or "MaTrIxX0")
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- Matrix TeAM .',url="t.me/MaTrIxX0"}},
}
local msg_id = msg.id_/2097152/0.5
...
inline = {
{{text = '• Matrix 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/MaTrIxX0'}},
}
