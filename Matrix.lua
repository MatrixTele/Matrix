...
function Function_Matrix(extra, result, success)
database:sadd(bot_id.."Matrix:Basic:Constructoryyu23"..msg.chat_id_, result.sender_user_id_)
...
database:sadd(bot_id.."Matrix:Basic:Constructoryyu23"..msg.chat_id_, result.id_)
...
function Function_Matrix(extra, result, success)
database:srem(bot_id.."Matrix:Basic:Constructoryyu23"..msg.chat_id_, result.sender_user_id_)
...
function Function_Matrix(extra, result, success)
if result.id_ then
database:srem(bot_id.."Matrix:Basic:Constructoryyu23"..msg.chat_id_, result.id_)
