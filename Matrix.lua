...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,114518657,1141691695}
print("\27[34m"..[[
...
if text == (database:get(bot_id.."Matrix:Name:Bot") or "سبايدر") then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
Namebot = (database:get(bot_id.."Matrix:Name:Bot") or "سبايدر")
local namebot = {
...
𓂅 . [The programmer .](https://t.me/V7VVY)
*••┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉••*
...
local Name_Bot = (database:get(bot_id.."Matrix:Name:Bot") or "سبايدر")
