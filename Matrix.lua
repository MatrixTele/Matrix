...
if link then                              
send(msg.chat_id_,msg.id_,"📈┇𝗚𝗥𝗢𝗨𝗣 𝗟𝗜𝗡𝗞 ~\n ["..link.."]")                          
else                
...
local json_file, res = https.request("https://raw.githubusercontent.com/MatrixTele/files_tshake/master/files_tshake/"..file)
if res == 200 then
