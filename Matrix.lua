...
local t = ' \n⌔︙تم تفعيل غنيلي'
send(msg.chat_id_, msg.id_,t)
database:del(bot_id..'Rio:aqane:Rio'..msg.chat_id_) 
end
if text == "تعطيل اغنيه" and Owner(msg)  then
local t = ' \n⌔︙تم تعطيل غنيلي'
send(msg.chat_id_, msg.id_,t)
database:set(bot_id..'Rio:aqane:Rio'..msg.chat_id_,true)  
end
if text == "اغنيه" and not database:get(bot_id..'Rio:aqane:Rio'..msg.chat_id_)  then
