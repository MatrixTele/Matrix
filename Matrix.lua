...
sendPhoto(msg.chat_id_,msg.id_,Hussain.photos_[0].sizes_[1].photo_.persistent_id_,get_id)
else
sendPhoto(msg.chat_id_,msg.id_,Hussain.photos_[0].sizes_[1].photo_.persistent_id_,'◊￤'..Description..'\n◊￤ايديك ↺ '..Id..'\n◊￤معرفك ↺ '..UserName_User..'\n◊￤رتبتك ↺ '..Status_Gps..'\n◊￤رسائلك ↺ '..NumMsg..'\n◊￤السحكات ↺ '..message_edit..' \n◊￤تتفاعلك ↺ '..TotalMsg..'\n◊￤مجوهراتك ↺ '..Num_Games)
end
else
...
tdcli_function ({ID = "GetUser",user_id_ = 1874628385},function(arg,data) 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = 1874628385,offset_ = 0,limit_ = 1},function(extra,bo,success) 
local Text = "* Dev Name ↬ * ["..data.first_name_.."](T.me/"..data.username_..")\n*Dev User ↬* [@"..data.username_.."]"
if bo.photos_[0] then
x = {} 
x.inline_keyboard = {
