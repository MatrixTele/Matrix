...
elseif status == "listNewCmmd" then
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '⌔︙عدد الاوامر المضافه : '..#listNewCmmd, callback_data=user_id..""},
},
{
...
return SendMsg_Msgeeslist("listNewCmmd",msg.chat_id_,msg.sender_user_id_,msg.id_, t)
end
